...
class get_move_cmds(Node):
    ...
    def __init__(self):
        ...
        self.cBR = True; #Current State to button respond; false-> do not respond to button; true ->respond to button
        self.nBR = True;#Next state of will we respond to button
    ...
    def toggle(self, state):
        print("past mode:",self.rover_modeC)
        if state == 0:
        ...
        print("current mode:",self.rover_modeC)
        
    def joy_callback(self, data):
        Bu = data.buttons[4] #Button press
        self.nBR=not Bu #Next state of Button respond
        #Toggle when you go from respond to button to don't respond to button
        if((not self.nBR)and self.cBR):
            print("Button Toggled")
            self.toggle(self.toggle_button)
            # time.sleep(0.3);
        self.cBR=self.nBR #Update State
    ...
    def core_cmd_vel_callback1(self):
        ...
        msg.linear.x = u_lx1
        msg.angular.z = u_az1
        self.pub_robot1_cmd_vel.publish(msg)
        self.i += 1
    ...
    def core_cmd_vel_callback2(self):
        ...
        msg.linear.x = u_lx2
        msg.angular.z = u_az2
        self.pub_robot2_cmd_vel.publish(msg)
        self.i += 1
    ...
    def core_cmd_vel_callback3(self):
        ...
        msg.linear.x = u_lx3
        msg.angular.z = u_az3
        self.pub_robot3_cmd_vel.publish(msg)
        self.i += 1
